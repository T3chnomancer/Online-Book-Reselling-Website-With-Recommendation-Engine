...
{
$id=$_POST['id'];
$delete = "DELETE FROM user_reg WHERE uid='$id'";
mysql_query( $delete);
}
?>
...
if(isset($_POST['sid']))
{
	$searchid=$_POST['sid'];
					...
					$per_page = 5;
					$select_table = "select * from user_reg  where concat(Name,' ',Email,' ',Mobile) like '%$searchid%'";
...
<TD><a href="#" class="ABCD" id="<?php echo $row['uid']; ?>">[ X ]</a>
</TD>
</TR>
<?php
}
