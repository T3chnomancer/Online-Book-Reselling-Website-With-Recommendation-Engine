...
{
$id=$_POST['ide'];
$select_table = "update bookcart set OrderEnd='y',orderdt='$Rdate' where cid=".$id;
...
<?PHP
					$per_page = 5; 
					$select_table = "select * from user_reg,bookcart,bookinfo where bookcart.uid=user_reg.uid and bookcart.bid=bookinfo.Bid and bookcart.ordercomplit='y' and bookcart.OrderEnd!='y' group by bookcart.cid";
					$fetch= mysql_query($select_table);
...
<a href="#" class="Edit" id="<?php echo $row['cid']; ?>">[ End ]</a>
</TD>
</TR>
<?php
}
